...
class mod_forumng_discussion {
     ...
     */
    public function get_num_replies() {
        if (!isset($this->discussionfields->numposts)) {
            throw new coding_exception('Post count not obtained');
        }
        return $this->discussionfields->numposts - 1;
    }

    /**
     * @return int Time of first post
     */
    public function get_time_created() {
        if (!isset($this->discussionfields->timecreated)) {
            throw new coding_exception('Time created not obtained');
        }
        return $this->discussionfields->timecreated;
    }
