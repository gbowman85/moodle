...
$THEME->doctype = 'html5';
$THEME->sheets = array('oba', 'font-awesome', 'custom', 'snap','mobile');
$THEME->lessfile = 'moodle';
$THEME->parents_exclude_sheets = array('bootstrapbase' => array('moodle'), 'clean' => array('custom'));
$THEME->lessvariablescallback = 'theme_obam_less_variables';
$THEME->extralesscallback = 'theme_obam_extra_less';
$THEME->supportscssoptimisation = true;
$THEME->yuicssmodules = array();
$THEME->enable_dock = false;
$THEME->editor_sheets = array();
$THEME->rendererfactory = 'theme_overridden_renderer_factory';
$THEME->csspostprocess = 'theme_obam_process_css';
