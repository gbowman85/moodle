 ...
 */
 ...
 class theme_obam_core_renderer extends theme_bootstrapbase_core_renderer {
            /*
        ...
        */
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_obam');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_obam');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_obam');
            } else {
                $branchtitle = get_string('mycourses', 'theme_obam');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_obam');
