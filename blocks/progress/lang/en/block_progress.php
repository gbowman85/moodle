...
$string['marked_colour_title'] = 'Marked Colour';
$string['marked_colour_descr'] = 'HTML Colour code for elements that have been marked';
$string['submitted_colour_title'] = 'Submitted Colour';
$string['submitted_colour_descr'] = 'HTML Colour code for elements that have been submitted but not marked';
