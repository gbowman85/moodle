 ...
 * the {@link theme_obam_less_variables()} here because we need to create selectors or
 * alter existing ones.
 *
 * @param theme_config $theme The theme config object.
 * @return string Raw LESS code.
 */
function theme_obam_extra_less($theme) {
    $content = '';
 ...
 */
function theme_obam_less_variables($theme) {
    $variables = array();
...
function theme_obam_process_css($css, $theme) {
    ...
    $css = theme_obam_set_customcss($css, $customcss);
    ...
    $css = theme_obam_set_headingfont($css, $headingfont);
    $css = theme_obam_set_bodyfont($css, $bodyfont);
    $css = theme_obam_set_bodysize($css, $bodysize);
    $css = theme_obam_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_obam_set_marketboxcolor($css, $marketboxcolor);
    ...
    $css = theme_obam_set_topicweekcolor($css, $topicweekcolor);
    ...
    $css = theme_obam_set_swicontext($css, $swicontext);
    ...
    $css = theme_obam_set_swpost($css, $swpost);
    ...
    $css = theme_obam_set_swaddpost($css, $swaddpost);
    ...
    $css = theme_obam_set_swmessage($css, $swmessage);
    ...
    $css = theme_obam_set_swattach($css, $swattach);
    ...
    $css = theme_obam_set_swcomment($css, $swcomment);
    ...
    $css = theme_obam_set_swlabelpost($css, $swlabelpost);
    ...
    $css = theme_obam_set_swlabelmessage($css, $swlabelmessage);
    ...
    $css = theme_obam_set_swlabelcomment($css, $swlabelcomment);
    ...
    $css = theme_obam_set_swlabelattachment($css, $swlabelattachment);
    ...
    $css = theme_obam_set_swmultilangcss($css, $swmultilangcss);
 ...
 */
function theme_obam_set_customcss($css, $customcss) {
...
function theme_obam_set_marketboxcolor($css, $marketboxcolor) {
...
function theme_obam_set_topicweekcolor($css, $topicweekcolor) {
...
function theme_obam_set_swlabelpost($css, $swlabelpost) {
...
//Adds custom Socialwall Labels
function theme_obam_set_swlabelmessage($css, $swlabelmessage) {
...
//Adds custom Socialwall Labels
function theme_obam_set_swlabelcomment($css, $swlabelcomment) {
...
//Adds custom Socialwall Labels
function theme_obam_set_swlabelattachment($css, $swlabelattachment) {
...
function theme_obam_set_swicontext($css, $swicontext) {
...
//Adds custom Socialwall Icon and text color
function theme_obam_set_swpost($css, $swpost) {
    $tag = '[[setting:swpost]]';
    $replacement = $swpost;
        if (is_null($replacement)) {
        $replacement = '';
...
//Adds custom Socialwall Icon and text color
function theme_obam_set_swaddpost($css, $swaddpost) {
...
//Adds custom Socialwall Icon and text color
function theme_obam_set_swmessage($css, $swmessage) {
...
function theme_obam_set_swattach($css, $swattach) {
...
//Adds custom Socialwall attachment color
function theme_obam_set_swcomment($css, $swcomment) {
...
function theme_obam_set_swmultilangcss($css, $swmultilangcss) {
 ...
 */
function theme_obam_set_logosmall($css, $logosmall) {
...
function theme_obam_set_headingfont($css, $headingfont) {
...
function theme_obam_set_bodyfont($css, $bodyfont) {
...
function theme_obam_set_bodysize($css, $bodysize) {
...
function theme_obam_set_bodyweight($css, $bodyweight) {
 ...
 */
function theme_obam_set_fpbkg($css, $fpbkg) {
    $tag = '[[setting:fpbkg]]';
    $replacement = $fpbkg;
    if (is_null($replacement)) {
        $replacement = '';
 ...
 * @return bool
 */
function theme_obam_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
...
function theme_obam_page_init(moodle_page $page) {
$page->requires->jquery_plugin('tab', 'theme_obam');
}
